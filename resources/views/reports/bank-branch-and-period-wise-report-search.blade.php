...
@section('maincontent')
	<div class="content-container container-fluid">
        <div class="page-heading">
            <h1 class="heading-title">Bank Branch & Period Wise Report</h1>
        </div>
        <div class="row">
            <div class="col-md-6">
                <div class="card card-header-nobg-bb mb-3">
                    ...
                    <div class="card-body">
                        <div class="custom-control custom-radio custom-control-inline">
                            ...
                            <label class="custom-control-label" for="radio_ledger_details">Ledger Details</label>
                        </div>
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="radio_ledger_summary" name="radio_report_pane" class="custom-control-input">
                            <label class="custom-control-label" for="radio_ledger_summary">Ledger Summary</label>
                        </div>
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="radio_lien_ledger" name="radio_report_pane" class="custom-control-input">
                            <label class="custom-control-label" for="radio_lien_ledger">Lien Ledger</label>
                        </div>
                    </div>
                </div>
            </div>
